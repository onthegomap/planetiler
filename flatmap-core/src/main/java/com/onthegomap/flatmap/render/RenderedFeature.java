...
/**
 * An encoded vector tile feature on a tile with an extra {@code zOrder} and {@code group} that define its placement in
 ...
 * @param zOrder            ordering of features in the output tile
...
public record RenderedFeature(
   ...
   *              this is the 4th feature in a group with lowest z-order then the feature is included if {@code limit <=
   *              4}
   */
