# Planetiler Cafe and Road Example Project

This example demonstrates:
- extracting cafes from OSM
- rendering roads
- visualizing with MapLibre
...
![Main Mune](screenshot/p1.png)


**Cafe and Roads**
![Cafe and Roads](screenshot/p2.png)

**More Details**
![More Details](screenshot/p3.png)
...
//due to old method reason, the main method above should change to below:
public static void main(String... args) throws Exception {
...
#change to this below,(due to the changes in main method), this will overwrite toilets.mbtiles
java -cp target/*-with-deps.jar com.onthegomap.planetiler.examples.MyProfile --force
```
...
#option2:
npx tileserver-gl-light data/toilets.mbtiles #Run TileServer (no install needed)
```
