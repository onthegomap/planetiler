...
public class LandcoverTest extends AbstractLayerTest {
    ...
    assertFeatures(
        ...
        List.of(
            Map.of(
                ...
                "_buffer", 4d)),
        glacier3);
    assertCoversZoomRange(0, 6, "landcover", glacier1, glacier2, glacier3);
  }
    ...
    assertFeatures(
        ...
        List.of(
            Map.of(
                ...
                "_buffer", 4d)),
        ice2);
    assertCoversZoomRange(2, 6, "landcover", ice1, ice2);
  }
    ...
    assertFeatures(
        ...
        List.of(
            Map.of(
                ...
                "_minzoom", 9,
                "_maxzoom", 14)),
        process(polygonFeature(Map.of("natural", "wood"))));
    assertFeatures(
        12,
        List.of(
            Map.of(
                ...
                "_maxzoom",
                14)),
        process(polygonFeature(Map.of("landuse", "forest"))));
    assertFeatures(
        10,
        List.of(
            Map.of(
                ...
                "_maxzoom",
                14)),
        process(polygonFeature(Map.of("natural", "dune"))));
    assertFeatures(10, List.of(), process(polygonFeature(Map.of("landuse", "park"))));
  }
  ...
  public void testMergeForestsBuNumPointsZ9to13() throws GeometryException {
    ...
    assertMerges(
        List.of(map, map, map, map, map, map),
        List.of(
            // don't merge any
  ...
  private VectorTile.Feature feature(
      org.locationtech.jts.geom.Polygon geom, Map<String, Object> m) {
    return new VectorTile.Feature(
        "landcover", 1, VectorTile.encodeGeometry(geom), new HashMap<>(m), 0);
  }

  private void assertMerges(
      List<Map<String, Object>> expected, List<VectorTile.Feature> in, int zoom)
      throws GeometryException {
    assertEquals(
        expected,
        profile.postProcessLayerFeatures("landcover", zoom, in).stream()
            .map(VectorTile.Feature::attrs)
            .toList());
  }
}
