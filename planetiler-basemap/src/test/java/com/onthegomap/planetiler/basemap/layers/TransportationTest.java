...
public class TransportationTest extends AbstractLayerTest {
    ...
    assertFeatures(
        ...
        List.of(
            Map.of(
                ...
                "class", "motorway",
                "toll", "<null>")),
        process(lineFeature(Map.of("highway", "motorway"))));
    assertFeatures(
        9,
        List.of(
            Map.of(
  ...
  public void testMotorwayJunction() {
    ...
    // 2 ways meet at junctionNode (id=2) - use most important class of a highway intersecting it
    // (motorway)
    ...
    FeatureCollector features =
        process(
            SimpleFeature.create(
                newPoint(1, 2), junctionNode.tags(), OSM_SOURCE, null, junctionNode.id()));
  ...
  public void testInterstateMotorwayWithoutWayInfo() {
    ...
    FeatureCollector features =
        process(
            lineFeatureWithRelation(
                profile.preprocessOsmRelation(rel), Map.of("highway", "motorway")));
  ...
  public void testRaceway() {
    assertFeatures(
        13,
        List.of(
            Map.of("_layer", "transportation", "class", "raceway", "oneway", 1, "_minzoom", 12),
            Map.of(
                "_layer", "transportation_name",
                "class", "raceway",
                "name", "Climbing Turn",
  ...
  public void testRail() {
    ...
    assertFeatures(
        13,
        List.of(Map.of("layer", "<null>", "_minzoom", 10)),
        process(
            lineFeature(
                Map.of(
                    "railway", "rail",
                    "name", "Boston Subdivision"))));
    assertFeatures(13, List.of(), process(polygonFeature(Map.of("railway", "rail"))));
    assertFeatures(
        13,
        List.of(
            Map.of(
    ...
    assertFeatures(
        ...
        List.of(
            Map.of(
                ...
                "_maxzoom", 14,
                "_type", "line")),
        process(lineFeature(Map.of("railway", "narrow_gauge"))));
  }
    ...
    assertFeatures(
        ...
        List.of(
            Map.of(
                ...
                "_maxzoom", 14,
                "_type", "polygon")),
        process(polygonFeature(Map.of("man_made", "pier"))));
    assertFeatures(
        10,
        List.of(
            Map.of(
                ...
                "_maxzoom", 14,
                "_type", "line")),
        process(lineFeature(Map.of("man_made", "pier"))));
  }

  @Test
  public void testPedestrianArea() {
    Map<String, Object> pedestrianArea =
        Map.of(
            "_layer", "transportation",
            "class", "path",
            "subclass", "pedestrian",
            ...
            "_maxzoom", 14,
            "_type", "polygon");
    Map<String, Object> circularPath =
        Map.of(
            "_layer", "transportation",
            "class", "path",
            "subclass", "pedestrian",
  ...
  public void testTransportationNameLayerRequiresTransportationLayer() {
    var profile =
        new BasemapProfile(
            translations,
            PlanetilerConfig.from(Arguments.of("only_layers", "transportation_name")),
            Stats.inMemory());
