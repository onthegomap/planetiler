...
public class WaterwayTest extends AbstractLayerTest {
  ...
  public void testOsmWaterwayRelation(boolean isLongEnough) throws GeometryException {
    ...
    assertEquals(
        ...
        profile.postProcessLayerFeatures(
            Waterway.LAYER_NAME, 8, new ArrayList<>(List.of(line1, line2))));
  }
  ...
  public void testWaterwayImportantRiverProcess() {
    ...
    assertFeatures(
        ...
        charlesRiver);
    assertFeatures(
        10, List.of(Map.of("class", "river", "_buffer", 26.165329093358647)), charlesRiver);
    assertFeatures(
        9, List.of(Map.of("class", "river", "_buffer", 26.165329093358647)), charlesRiver);
  }
  ...
  public void testWaterwayImportantRiverPostProcess() throws GeometryException {
    ...
    assertEquals(List.of(), profile.postProcessLayerFeatures(Waterway.LAYER_NAME, 11, List.of()));
    assertEquals(
        List.of(line1, line2),
