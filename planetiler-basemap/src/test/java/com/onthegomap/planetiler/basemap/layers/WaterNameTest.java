...
public class WaterNameTest extends AbstractLayerTest {
  ...
  public void testWaterNamePoint() {
    ...
    assertFeatures(
        ...
        List.of(
            Map.of("_layer", "water"),
            Map.of("_layer", "water_name", "_type", "point", "_minzoom", 11, "_maxzoom", 14)),
        process(
            polygonFeatureWithArea(
                z11area,
                Map.of(
    ...
    assertFeatures(
        ...
        process(
            SimpleFeature.create(
                ...
                new HashMap<>(Map.<String, Object>of("OSM_ID", -10)),
    ...
    assertFeatures(
        ...
        List.of(
            ...
            Map.of(
                ...
                "line",
                "_geom",
                new TestUtils.NormGeometry(GeoUtils.latLonToWorldCoords(newLineString(0, 0, 1, 1))),
                "_minzoom",
                9,
                "_maxzoom",
                14,
  ...
  public void testMarinePoint() {
    assertFeatures(
        ...
        process(
            SimpleFeature.create(
                newLineString(0, 0, 1, 1),
                new HashMap<>(Map.<String, Object>of("scalerank", 1, "name", "Black sea")),
    ...
    assertFeatures(
        10,
        List.of(Map.of("_layer", "water_name", "_type", "point", "_minzoom", 0, "_maxzoom", 14)),
        process(
            pointFeature(
                Map.of(
                    "rank", 9,
    ...
    assertFeatures(
        10,
        List.of(Map.of("_layer", "water_name", "_type", "point", "_minzoom", 9, "_maxzoom", 14)),
        process(
            pointFeature(
                Map.of(
                    "rank", 9,
    ...
    assertFeatures(
        10,
        List.of(Map.of("_layer", "water_name", "_type", "point", "_minzoom", 8, "_maxzoom", 14)),
        process(
            pointFeature(
                Map.of(
                    "name", "Atlantic",
