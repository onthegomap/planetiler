 ...
 *   <li>then run this example: {@code java -cp target/*-fatjar.jar com.onthegomap.flatmap.examples.ToiletsOverlay osm_path="path/to/data.osm.pbf" mbtiles="data/output.mbtiles"}</li>
