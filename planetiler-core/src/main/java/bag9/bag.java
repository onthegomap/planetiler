...
public class bag extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7956392951338976177L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"bag\",\"namespace\":\"bag9\",\"fields\":[{\"name\":\"array_element\",\"type\":[\"null\",{\"type\":\"map\",\"values\":[\"null\",\"string\"]}],\"default\":null}]}");
   ...
   */
  public static bag9.bag.Builder newBuilder() {
    return new bag9.bag.Builder();
  }
   ...
   * @return A new bag RecordBuilder
   */
  public static bag9.bag.Builder newBuilder(bag9.bag.Builder other) {
    if (other == null) {
      return new bag9.bag.Builder();
    } else {
      return new bag9.bag.Builder(other);
    }
  }
   ...
   * @return A new bag RecordBuilder
   */
  public static bag9.bag.Builder newBuilder(bag9.bag other) {
    if (other == null) {
      return new bag9.bag.Builder();
    } else {
      return new bag9.bag.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<bag>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(bag9.bag.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(bag9.bag other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.array_element)) {
        this.array_element = data().deepCopy(fields()[0].schema(), other.array_element);
    ...
    /**
      ...
      * @return This builder.
      */
    public bag9.bag.Builder setArrayElement(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public bag9.bag.Builder clearArrayElement() {
      array_element = null;
