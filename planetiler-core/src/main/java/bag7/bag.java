...
public class bag extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5058447515107493400L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"bag\",\"namespace\":\"bag7\",\"fields\":[{\"name\":\"array_element\",\"type\":[\"null\",{\"type\":\"map\",\"values\":[\"null\",\"string\"]}],\"default\":null}]}");
   ...
   */
  public static bag7.bag.Builder newBuilder() {
    return new bag7.bag.Builder();
  }
   ...
   * @return A new bag RecordBuilder
   */
  public static bag7.bag.Builder newBuilder(bag7.bag.Builder other) {
    if (other == null) {
      return new bag7.bag.Builder();
    } else {
      return new bag7.bag.Builder(other);
    }
  }
   ...
   * @return A new bag RecordBuilder
   */
  public static bag7.bag.Builder newBuilder(bag7.bag other) {
    if (other == null) {
      return new bag7.bag.Builder();
    } else {
      return new bag7.bag.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<bag>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(bag7.bag.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(bag7.bag other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.array_element)) {
        this.array_element = data().deepCopy(fields()[0].schema(), other.array_element);
    ...
    /**
      ...
      * @return This builder.
      */
    public bag7.bag.Builder setArrayElement(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public bag7.bag.Builder clearArrayElement() {
      array_element = null;
