...
public class bag extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8856575726845834908L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"bag\",\"namespace\":\"bag4\",\"fields\":[{\"name\":\"array_element\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public static bag4.bag.Builder newBuilder() {
    return new bag4.bag.Builder();
  }
   ...
   * @return A new bag RecordBuilder
   */
  public static bag4.bag.Builder newBuilder(bag4.bag.Builder other) {
    if (other == null) {
      return new bag4.bag.Builder();
    } else {
      return new bag4.bag.Builder(other);
    }
  }
   ...
   * @return A new bag RecordBuilder
   */
  public static bag4.bag.Builder newBuilder(bag4.bag other) {
    if (other == null) {
      return new bag4.bag.Builder();
    } else {
      return new bag4.bag.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<bag>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(bag4.bag.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(bag4.bag other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.array_element)) {
        this.array_element = data().deepCopy(fields()[0].schema(), other.array_element);
    ...
    /**
      ...
      * @return This builder.
      */
    public bag4.bag.Builder setArrayElement(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public bag4.bag.Builder clearArrayElement() {
      array_element = null;
