...
public class bag extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7457604411001709094L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"bag\",\"namespace\":\"com.onthegomap.planetiler.overture.avrogen\",\"fields\":[{\"name\":\"array_element\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public static com.onthegomap.planetiler.overture.avrogen.bag.Builder newBuilder() {
    return new com.onthegomap.planetiler.overture.avrogen.bag.Builder();
  }
   ...
   * @return A new bag RecordBuilder
   */
  public static com.onthegomap.planetiler.overture.avrogen.bag.Builder newBuilder(com.onthegomap.planetiler.overture.avrogen.bag.Builder other) {
    if (other == null) {
      return new com.onthegomap.planetiler.overture.avrogen.bag.Builder();
    } else {
      return new com.onthegomap.planetiler.overture.avrogen.bag.Builder(other);
    }
  }
   ...
   * @return A new bag RecordBuilder
   */
  public static com.onthegomap.planetiler.overture.avrogen.bag.Builder newBuilder(com.onthegomap.planetiler.overture.avrogen.bag other) {
    if (other == null) {
      return new com.onthegomap.planetiler.overture.avrogen.bag.Builder();
    } else {
      return new com.onthegomap.planetiler.overture.avrogen.bag.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<bag>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.onthegomap.planetiler.overture.avrogen.bag.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.onthegomap.planetiler.overture.avrogen.bag other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.array_element)) {
        this.array_element = data().deepCopy(fields()[0].schema(), other.array_element);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.onthegomap.planetiler.overture.avrogen.bag.Builder setArrayElement(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.onthegomap.planetiler.overture.avrogen.bag.Builder clearArrayElement() {
      array_element = null;
