...
/**
 * An error caused by unexpected input geometry that should be handled to avoid halting the entire
 * program for bad data we are sure to encounter in the wild.
 */
public class GeometryException extends Exception {
   ...
   *
   * @param stat string that uniquely defines this error that will be used to count number of
   *     occurrences in stats
   * @param message description of the error to log that should be detailed enough that you can find
   *     the offending geometry from it
  ...
  /**
   * Returns the unique code for this error condition to use for counting the number of occurrences
   * in stats.
   */
  public String stat() {
    return stat;
  ...
  public static class Verbose extends GeometryException {
     ...
     * @param stat string that uniquely defines this error that will be used to count number of
     *     occurrences in stats
     * @param message description of the error to log that should be detailed enough that you can
     *     find the offending geometry from it
     * @param cause the original exception that was thrown
     */
